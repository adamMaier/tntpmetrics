...
In the above, notice that Core Actions 2 and 3, and Culture of Learning were rescaled in order to calculate the IPG construct (`cm_ipg`) but are returned to you in their orignal scale of 1-4.
