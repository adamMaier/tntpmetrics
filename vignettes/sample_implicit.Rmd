...
There above examples assume a familiarity with `purrr` and indeed there are other ways to use `sample_implicit` with other existing R functions meet your needs. The point is to simply highlight how you can build upon `sample_implicit` to accomplish your sampling needs.
